...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '#t8p-panel-gallery-hdr{padding:24px 0 20px 0;max-width:900px;margin:0 auto;box-sizing:border-box}',
      '@media(max-width:960px){#t8p-panel-gallery-hdr{padding:24px 24px 20px 24px;max-width:none;margin:0}}',
      ...
      '.t8p-gal-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:10px;padding:0;max-width:900px;margin:0 auto;box-sizing:border-box}',
      '@media(max-width:960px){.t8p-gal-grid{grid-template-columns:repeat(3,1fr);gap:10px;max-width:none;padding:0 24px}}',
