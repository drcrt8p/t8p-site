...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '#t8p-pp-wm svg{height:42.5px!important;width:auto!important;max-height:42.5px;',
      'flex-shrink:0;display:block;align-self:center}',
      '#t8p-pp-wm svg *{fill:#c9e6fd!important}',
      '@media(max-width:767px){#t8p-pp-wm{height:54px}#t8p-pp-wm svg{height:27px!important;max-height:27px}}',
      ...
      '#t8p-scrub-head{position:fixed;top:0;bottom:40px;width:1px;background:#c9e6fd;',
      'pointer-events:none;z-index:9091;opacity:0;left:-999px;transition:opacity .3s}',
      ...
      '.t8p-credit-name[href]:hover{opacity:.45}',
      '@media(max-width:767px){#t8p-credits-inner{padding:10px 20px}.t8p-credit-role{width:130px}}',
      ...
      '.t8p-dock-stack .t8p-dock-card:nth-child(2){top:2px;left:-2px;z-index:4;transform:rotate(-3deg);transform-origin:bottom center;background:#8ab8d8}',
      '.t8p-dock-stack .t8p-dock-card:nth-child(3){top:2px;left:2px;z-index:3;transform:rotate(3deg);transform-origin:bottom center;background:#c9e6fd}',
      '.t8p-dock-stack .t8p-dock-card:nth-child(4){top:4px;left:-4px;z-index:2;transform:rotate(-5deg);transform-origin:bottom center;background:#8ab8d8}',
      '.t8p-dock-stack .t8p-dock-card:nth-child(5){top:4px;left:4px;z-index:1;transform:rotate(5deg);transform-origin:bottom center;background:#c9e6fd}',
      '.t8p-dock-stack:hover .t8p-dock-card:nth-child(2){transform:rotate(-10deg);transform-origin:bottom center}',
      '.t8p-dock-stack:hover .t8p-dock-card:nth-child(3){transform:rotate(10deg);transform-origin:bottom center}',
      ...
      '.t8p-dock-badge{position:absolute;bottom:-6px;right:-6px;background:#080808;color:#c9e6fd;border:1px solid rgba(201,230,253,.5);font-family:monospace;font-size:9px;font-weight:700;width:20px;height:20px;border-radius:50%;display:flex;align-items:center;justify-content:center;z-index:10}',
      ...
      '#t8p-panel-wm{width:130px;height:44px;display:flex;align-items:center;justify-content:center;overflow:hidden}',
      '#t8p-panel-wm svg{width:100%;height:100%;fill:#f0ede6}',
      '#t8p-panel-close{width:36px;height:36px;border-radius:50%;',
      'border:1px solid rgba(201,230,253,.25);background:transparent;color:#c9e6fd;',
      'font-size:16px;cursor:pointer;display:flex;align-items:center;justify-content:center;',
      'transition:border-color .2s}',
      '#t8p-panel-close:hover{border-color:#c9e6fd;background:rgba(201,230,253,.06)}',
      '#t8p-panel-body{flex:1;display:grid;grid-template-columns:1fr 1fr;min-height:0;overflow:hidden}',
      '#t8p-panel-left{display:flex;flex-direction:column;padding:32px 36px 32px 40px;border-right:1px solid rgba(255,255,255,.06);min-height:0;overflow:hidden}',
      '#t8p-panel-right{display:flex;flex-direction:column;padding:32px 40px 32px 36px;min-height:0;overflow:hidden}',
      '.t8p-panel-hdr{margin-bottom:20px;border-bottom:1px solid rgba(255,255,255,.07);padding-bottom:20px;flex-shrink:0}',
      '.t8p-panel-index{font-family:monospace;font-size:9px;letter-spacing:.15em;color:rgba(201,230,253,.35);text-transform:uppercase;margin-bottom:8px}',
      '.t8p-panel-title{font-size:clamp(14px,1.8vw,24px);font-weight:700;color:#fff;letter-spacing:-.01em;line-height:1.1;margin-bottom:10px}',
      '.t8p-panel-meta{display:flex;gap:16px;flex-wrap:wrap;font-family:monospace;font-size:9px;letter-spacing:.12em;color:rgba(201,230,253,.4);text-transform:uppercase;margin-bottom:12px}',
      '.t8p-panel-note{font-family:monospace;font-size:9px;letter-spacing:.06em;line-height:1.6;color:rgba(201,230,253,.35);font-style:italic}',
      '.t8p-panel-slab{font-family:monospace;font-size:9px;letter-spacing:.2em;color:rgba(255,255,255,.2);text-transform:uppercase;margin-bottom:12px;flex-shrink:0}',
      '.t8p-panel-videos{flex:1;display:flex;flex-direction:column;gap:12px;min-height:0}',
      '.t8p-panel-vblock{flex:1;display:flex;flex-direction:column;min-height:0}',
      ...
      /* ── Woxerpolaroid gallery-style panel (David, Jul 2026) ── */
      '#t8p-panel-gallery{flex:1;overflow-y:auto;overflow-x:hidden;padding:0 0 60px 0}',
      '#t8p-panel-gallery-hdr{padding:36px 40px 32px 40px;max-width:900px}',
      '@media(max-width:767px){#t8p-panel-gallery-hdr{padding:24px 20px 20px 20px}}',
      '.t8p-galhdr-title{font-size:clamp(14px,1.8vw,24px);font-weight:700;color:#fff;letter-spacing:-.01em;line-height:1.1;margin-bottom:16px}',
      '.t8p-galhdr-meta{display:flex;gap:20px;flex-wrap:wrap;font-family:monospace;font-size:10px;letter-spacing:.14em;color:rgba(201,230,253,.55);text-transform:uppercase;margin-bottom:16px}',
      '.t8p-galhdr-body{font-size:14px;line-height:1.65;color:rgba(240,237,230,.7);max-width:640px}',
      '.t8p-galhdr-body p{margin:0 0 12px 0}',
      '.t8p-gal-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:16px;padding:0 40px}',
      '@media(max-width:900px){.t8p-gal-grid{grid-template-columns:repeat(3,1fr);gap:12px;padding:0 24px}}',
      '@media(max-width:600px){.t8p-gal-grid{grid-template-columns:repeat(2,1fr);gap:10px;padding:0 20px}}',
      '.t8p-gal-tile{position:relative;cursor:pointer;transition:opacity .2s}',
      '.t8p-gal-tile:hover{opacity:.82}',
      '.t8p-gal-tile img{width:100%;height:auto;display:block}',
      '.t8p-gal-tile-num{position:absolute;top:12px;left:14px;font-family:monospace;font-size:10px;letter-spacing:.15em;color:#c9e6fd;background:rgba(8,8,8,.7);padding:3px 8px;border-radius:2px;pointer-events:none;z-index:2}',
      /* ── Lightbox ── */
      '#t8p-lb{position:fixed;inset:0;background:#080808;z-index:10000;',
      'display:none;align-items:center;justify-content:center}',
      '#t8p-lb.open{display:flex}',
      '#t8p-lb-img{max-width:56vw;max-height:72vh;object-fit:contain;user-select:none;',
      'display:block}',
      '@media(max-width:900px){#t8p-lb-img{max-width:80vw;max-height:65vh}}',
      '@media(max-width:767px){#t8p-lb-img{max-width:92vw;max-height:60vh}}',
      '#t8p-lb-bar{position:fixed;top:0;left:0;right:0;height:44px;',
      'display:flex;align-items:center;justify-content:space-between;padding:0 24px;',
      'z-index:10001}',
      '#t8p-lb-close{width:40px;height:40px;border-radius:50%;border:1px solid rgba(201,230,253,.5);',
      'background:rgba(8,8,8,.6);color:#c9e6fd;font-size:15px;cursor:pointer;',
      'display:flex;align-items:center;justify-content:center;transition:all .2s}',
      '#t8p-lb-close:hover{border-color:#c9e6fd;background:rgba(201,230,253,.12)}',
      '#t8p-lb-counter{font-family:monospace;font-size:11px;letter-spacing:.15em;',
      'color:rgba(201,230,253,.7)}',
      '.t8p-lb-nav{position:fixed;top:50%;transform:translateY(-50%);',
      'width:52px;height:52px;border-radius:50%;',
      'background:rgba(8,8,8,.6);border:1px solid rgba(201,230,253,.5);',
      'color:#c9e6fd;font-size:22px;cursor:pointer;padding:0;z-index:10001;',
      'display:flex;align-items:center;justify-content:center;',
      'transition:all .2s;user-select:none;line-height:1}',
      '.t8p-lb-nav:hover{border-color:#c9e6fd;background:rgba(201,230,253,.12)}',
      '#t8p-lb-prev{left:24px}#t8p-lb-next{right:24px}',
      '@media(max-width:767px){.t8p-lb-nav{width:44px;height:44px;font-size:18px}#t8p-lb-prev{left:12px}#t8p-lb-next{right:12px}}',
    ].join('');
  ...
  function buildProject() {
    ...
    /* ── Playhead vline (tracks video progress) ── */
    var scrubHead = document.createElement('div');
    scrubHead.id = 't8p-scrub-head';
    pp.appendChild(scrubHead);

    /* Grab zone: invisible strip around the playhead for dragging */
    ...
    if (hasExtras) buildDockPanel(pp, vidsAll, hashes, d, title, desc, release, hasGallery, sl);
    ...
    /* ── UI visibility (sleep system) ── */
    var _sleepTimer = null;
    var _uiShown = false;

    function showUI() {
      if (!_uiShown) { _uiShown = true; pp.classList.add('ui-visible'); }
      ...
      _sleepTimer = setTimeout(function(){
        ...
        if (vidCur) { vidCur.style.opacity='0'; vidCur.style.pointerEvents='none'; }
      }, 3000);
    }
    function wakeUI() {
    ...
    var _headPct = 0; /* 0-1, tracks video progress */
    ...
    function onVimeoSDKReady() {
      ...
      vplayer.on('timeupdate', function(data){
        ...
        updateHeadPos(pct);
        /* show ui when video is playing with sound */
        if (!_muted && !_firstClick) showUI();
      });
    ...
    /* First click: restart from 0 unmuted, show UI */
  ...
  /* ─────────────────────────────────────────────────────────────
     ...
     Reuses #t8p-dock, .t8p-dock-stack, .t8p-dock-badge for the stack.
     Reuses #t8p-dock-panel container styles + topbar + close button.
     Reuses #t8p-lb lightbox from the base panel (needs to be built here too).
  ───────────────────────────────────────────────────────────── */
  function buildDockPanel_woxerpolaroid(pp, vidsAll, d, title, desc, release, bodyText) {
    var gimgs = (d && d.gimgs) ? d.gimgs.slice() : [];

    /* Dock/fan stack — identical to generic panel (locked behavior). */
    ...
    badge.textContent = gimgs.length || vidsAll.length;
    stack.appendChild(badge); dock.appendChild(stack);
    document.body.appendChild(dock);

    /* Panel — reuses #t8p-dock-panel container, topbar, close button. */
    ...
    /* Scrolling gallery body: header + grid. */
    ...
    if (bodyText) {
      var bodyEl = el('div',{className:'t8p-galhdr-body'});
      /* Split on double-newline for paragraphs; otherwise one <p>. */
      bodyText.split(/\n\n+/).forEach(function(para){
        var p = document.createElement('p'); p.textContent = para; bodyEl.appendChild(p);
      });
      hdr.appendChild(bodyEl);
    }
    gal.appendChild(hdr);

    /* Grid. */
    var grid = el('div',{className:'t8p-gal-grid'});
    gimgs.forEach(function(src, i){
      var tile = el('div',{className:'t8p-gal-tile'});
      var num = el('div',{className:'t8p-gal-tile-num'});
    ...
    /* Keyboard: Escape closes lightbox, or panel. Arrows navigate lightbox. */
    document.addEventListener('keydown', function onKey(e){
      if (!document.getElementById('t8p-pp')) { document.removeEventListener('keydown', onKey); return; }
      if (e.key === 'Escape'){
  ...
  function buildDockPanel(pp, vidsAll, hashes, d, title, desc, release, hasGallery, slug) {
    var bodyText  = d.body || '';
    ...
    var dock = el('div',{id:'t8p-dock'});
    var stack = el('div',{className:'t8p-dock-stack'});
    /* always 5 cards -- only card[0] gets the thumbnail, rest are color bg from CSS */
    for (var pi=0;pi<5;pi++) {
      var dcard = el('div',{className:'t8p-dock-card'});
      if (pi===0) {
        var dth = el('img');
    ...
    /* left col: meta + video */
    var pleft = el('div',{id:'t8p-panel-left'});
    ...
    hdr.appendChild(metaEl);
    if(bodyText){var bt=el('div',{className:'t8p-panel-note'}); bt.textContent=bodyText; hdr.appendChild(bt);}
    pleft.appendChild(hdr);
    if(vidsAll.length>0){
      var vslab=el('div',{className:'t8p-panel-slab'}); vslab.textContent='VIDEOS'; pleft.appendChild(vslab);
      ...
      pleft.appendChild(vgrid);
    }
    pbody.appendChild(pleft);

    /* right col: image grid */
    var galGrid=null;
    var pright = el('div',{id:'t8p-panel-right'});
    if(hasGallery){
      galGrid=el('div',{className:'t8p-panel-grid'});
      pright.appendChild(galGrid);
    }
    ...
    var lbBar=el('div',{id:'t8p-lb-bar'});
    var lbCounter=el('div',{id:'t8p-lb-counter'}); lbBar.appendChild(lbCounter);
    var lbClose=el('button',{id:'t8p-lb-close'}); lbClose.innerHTML='&#x2715;'; lbClose.setAttribute('aria-label','Close'); lbBar.appendChild(lbClose);
    lb.appendChild(lbBar);
    var lbImg=el('img',{id:'t8p-lb-img'}); lbImg.draggable=false; lb.appendChild(lbImg);
    ...
    function openPanel(){
      ...
      if(hasGallery&&galGrid&&!galGrid.children.length){
        ...
        : fetch(location.pathname+'?format=json-pretty')
          ...
          .then(function(json){
            var srcs=[];
            if(json&&json.items){json.items.forEach(function(item){if(item.assetUrl)srcs.push(item.assetUrl);});}
            if(!srcs.length){
