...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '.t8p-dock-stack{position:relative;width:80px;height:80px;cursor:pointer;overflow:visible}',
      ...
      /* Calm alternating fan -- separates cards clearly */
