...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '#t8p-panel-gallery-hdr{padding:24px 0 20px 0;max-width:1400px;margin:0 auto;box-sizing:border-box}',
      ...
      '.t8p-gal-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:10px;padding:0;max-width:1400px;margin:0 auto;box-sizing:border-box}',
